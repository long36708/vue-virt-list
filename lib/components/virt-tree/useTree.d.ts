...
export declare const TREE_TO_TOP = "toTop";
export declare const TREE_TO_BOTTOM = "toBottom";
export declare const TREE_ITEM_RESIZE = "itemResize";
export declare const TREE_RANGE_UPDATE = "rangeUpdate";
...
export declare const TreeEmits: {
    ...
    rangeUpdate: (inViewBegin: number, inViewEnd: number) => boolean;
