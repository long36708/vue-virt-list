...
export default defineComponent({
  ...
  render() {
    ...
    const slotExpandIcon = getSlot(this, 'icon')
      ? getSlot(this, 'icon')?.(node, isExpanded)
      : [defaultIcon];

    const slotLoadingIcon = getSlot(this, 'loadingIcon')
      ? getSlot(this, 'loadingIcon')?.(node)
      : [loadingIcon];
    ...
    const slotIcon = _h(
      ...
      [
        _h(
          ...
          node.isLoading ? slotLoadingIcon : slotExpandIcon,
        ),
      ],
    );
